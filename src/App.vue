<template>
  <main class="app">
    <section class="greeting">
      <h1 class="title">
        😎WAZZAP!
        <input type="text" placeholder="Enter name" v-model.lazy="name">

      </h1>
    </section>
    <!-- Todo 입력 -->
    <section class="create-todo">
      <h2>😍CREATE MY TODO</h2>
      <form action="" id="new-todo-form" v-on:submit.prevent="addTodo">
        <h4>What are you up 'TODO'?</h4>
        <input type="text" placeholder="Enter what 'TODO'" v-model.lazy="input_content">
